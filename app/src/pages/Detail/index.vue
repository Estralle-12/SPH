        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前路由跳转，从A路由跳转到B路由，这里在加入购物车，进行路由跳转之前，发请求把你购买的产品信息通过请求的形式通知服务器，服务器进行相应的存储 -->
...
export default {
  ...
  methods: {
    ...
    async addShopcar() {
      ...
      // 进行路由跳转
      // 在路由跳转的时候还需要将产品信息带给下一级路由组件
      // 产品信息的数据【比较复杂：skuInfo】，通过绘画存储，（不持久化，会话结束数据消失）
      // 本地存储|会话存储，一般存储的是字符串
      sessionStorage.setItem("SKUINFO",JSON.stringify(this.skuInfo))
      sessionStorage.setItem("SPU",JSON.stringify(this.spuSaleAttrList))
